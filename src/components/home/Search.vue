...
<template>
  <section class="heroe-search-background">
    <div class="backdrop-brightness-50 bg-black/30 px-4 py-32 mx-auto max-w-7xl">
    <div class="w-full mx-auto text-left md:w-11/12 xl:w-8/12 md:text-center">
      ...
      <p class="mb-6 text-lg text-gray-400 md:text-xl md:leading-normal text-center">
        ¡Bienvenido a nuestro gestor de libros! Aquí, puedes explorar nuestra amplia colección de libros.
      </p>
      <form class="w-full md:w-7/12 mx-auto grid grid-cols-1 lg:grid-cols-6pt-1 mb-8">
  <label class="col-auto lg:col-span-4">
    <input
      type="text"
      placeholder="Ingrese el nombre del libro..."
      class="w-full px-3 py-2.5 text-sm rounded-md border border-gray-200 shadow-sm focus:ring-orange-400 focus:border-orange-400"
      required
    />
  </label>
</form>
